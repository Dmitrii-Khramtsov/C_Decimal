...
START_TEST(is_greater_or_equal1) {
  ...
  int status = s21_is_greater_or_equal(first, second);
...
START_TEST(is_greater_or_equal15) {
...
START_TEST(is_greater_or_equal16) {
  s21_decimal value_1 = {{123456u, 654u, 0xFFFFFFFF, 0}};
...
START_TEST(is_greater_or_equal17) {
  s21_decimal value_1 = {{123456u, 654u, 0xFFFFFFFF, 0}};
  s21_decimal value_2 = {{123456u, 654u, 0xFFFFFFFF, 0}};
  int return_value = s21_is_greater_or_equal(value_1, value_2);
  ck_assert_int_eq(return_value, 1);
...
START_TEST(is_greater_or_equal18) {
  s21_decimal value_1 = {{12345, 0, 0, 0x00040000}};
  s21_decimal value_2 = {{12u, 0, 0, 0x00010000}};
  int return_value = s21_is_greater_or_equal(value_1, value_2);
  ck_assert_int_eq(return_value, 1);
}
END_TEST
...
Suite *test_greater_equal() {
  Suite *test_set = suite_create("s21_greater_equal");
  TCase *test_group = tcase_create("s21_greater_equal_test_group");

  tcase_add_test(test_group, is_greater_or_equal1);
  tcase_add_test(test_group, is_greater_or_equal2);
  tcase_add_test(test_group, is_greater_or_equal3);
  tcase_add_test(test_group, is_greater_or_equal4);
  tcase_add_test(test_group, is_greater_or_equal5);
  tcase_add_test(test_group, is_greater_or_equal6);
  tcase_add_test(test_group, is_greater_or_equal7);
  tcase_add_test(test_group, is_greater_or_equal8);
  tcase_add_test(test_group, is_greater_or_equal9);
  tcase_add_test(test_group, is_greater_or_equal10);
  tcase_add_test(test_group, is_greater_or_equal11);
  tcase_add_test(test_group, is_greater_or_equal12);
  tcase_add_test(test_group, is_greater_or_equal13);
  tcase_add_test(test_group, is_greater_or_equal14);
  tcase_add_test(test_group, is_greater_or_equal15);
  tcase_add_test(test_group, is_greater_or_equal16);
  tcase_add_test(test_group, is_greater_or_equal17);
  tcase_add_test(test_group, is_greater_or_equal18);
